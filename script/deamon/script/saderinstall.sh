...
#==================================================================
# 🌀 Vortex Daemon Installer Script - by spookyMC123 @ InfinityForge
#==================================================================
...
echo -e "${CYAN}${BOLD}"
echo "╔══════════════════════════════════════════════════════╗"
echo "║             🌀 Daemon - Automated Installer          ║"
...
echo -e "${CYAN}${EMOJI_GIT} Cloning the Daemon repository...${RESET}"
git clone https://github.com/PowerPort-Labs/sedar.git || {
...
# Done
echo -e "\n${GREEN}${EMOJI_SUCCESS} sedar deamon installed successfully!${RESET}"
